                    ...
                    <table class="rounded-t-lg w-full mx-auto bg-gray-200">
                        ...
                        @foreach($items as $item)
                            <tr class="bg-cool-gray-100 border-b border-gray-200">
                                ...
                                <td class="px-4 py-3 border-l-2"><a class="text-blue-700 hover:text-blue-500" href="{{route('user.get', ['id'=>$item["id"]])}}">Змінити</a> | <a class="text-blue-700 hover:text-blue-500" href="{{route('user.delete', ['id'=>$item["id"]])}}">Видалити</a></td>
                            </tr>
                        @endforeach
                    </table>
                </div>
