    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="max-w-max-content bg-white overflow-hidden shadow-md sm:rounded-lg mb-1">
                <a href="{{route('subject.view')}}" class="bg-green-400 flex justify-center items-center w-full text-white px-4 py-1 rounded-md focus:outline-none">Add</a>
            </div>
                    ...
                    <table class="rounded-t-lg w-full mx-auto bg-gray-200">
                        ...
                        @foreach($items as $item)
                            <tr class="bg-cool-gray-100 border-b border-gray-200">
                                ...
                                <td class="px-4 py-3 border-l-2"><a class="text-blue-700 hover:text-blue-500" href="{{route('subject.prepare', ['id'=>$item["id"]])}}">Змінити</a> | <a class="text-blue-700 hover:text-blue-500" href="{{route('subject.delete', ['id'=>$item["id"]])}}">Видалити</a></td>
                            </tr>
                        @endforeach
                    </table>
                        <br>
